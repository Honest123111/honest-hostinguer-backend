...
EMAIL_HOST_USER = "Kevin@honesttransportation.com" #
EMAIL_HOST_PASSWORD = "Honest123"
...
# This will use the DATABASE_URL environment variable in production
# and fall back to your existing DATABASES['default'] in development.
